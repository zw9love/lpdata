...
export default class Footer extends Component {
    constructor(props) {
        ...
        this.state = {
            mainData: [
                {
                    title: 'Why Carbon Black?',
                    secondMain: ['Complete Security Portfolio']
                },
                {
                    title: 'Why Carbon Black?',
                    secondMain: ['Complete Security Portfolio', 'Complete Security Portfolio']
                },
                {
                    title: 'Why Carbon Black?',
                    secondMain: ['Complete Security Portfolio', 'Complete Security Portfolio', 'Complete Security Portfolio']
                },
                {
                    title: 'Why Carbon Black?',
                    secondMain: ['Complete Security Portfolio', 'Complete Security Portfolio', 'Complete Security Portfolio', 'Complete Security Portfolio']
                },
                {
                    title: 'Why Carbon Black?',
                    secondMain: ['Complete Security Portfolio', 'Complete Security Portfolio', 'Complete Security Portfolio', 'Complete Security Portfolio', 'Complete Security Portfolio']
                }
                ...
                <div className={cx('footerWrapper')}>
                    ...
                    <div className={cx('footerBottomWrapper')}>
                        <div className={cx('footerBottomLeft')}>
                            <span>Copyright © 2017 Carbon Black, Inc.All rights reserved.</span>
                        </div>
